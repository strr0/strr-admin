...
public class OssClient {
    ...
    public OssClient(String configKey, OssProperties ossProperties) {
        ...
        try {
            ...
            if (!StringUtil.containsAny(properties.getEndpoint(), OssConstant.CLOUD_SERVICE)) {
    ...
    public String getUrl() {
        ...
        // 云服务商直接返回
        if (StringUtil.containsAny(endpoint, OssConstant.CLOUD_SERVICE)) {
    ...
    public String getPath(String prefix, String suffix) {
        ...
        // 文件路径
        String path = DateUtil.datePath() + "/" + uuid;
